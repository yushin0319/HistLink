...
describe('ResultHeader', () => {
  it('全ての情報が正しく表示される', () => {
    render(
      <ResultHeader lives={2} score={850} currentStage={8} totalStages={10} />,
    );
  ...
  it('currentStageは0-indexedなので表示は+1される', () => {
    render(
      <ResultHeader lives={3} score={500} currentStage={0} totalStages={10} />,
    );
  ...
  it('スコアが0の時も正しく表示される', () => {
    render(
      <ResultHeader lives={3} score={0} currentStage={5} totalStages={10} />,
    );
  ...
  it('ゲームクリア時（currentStage + 1 === totalStages）は"COMPLETE"と表示される', () => {
    render(
      <ResultHeader lives={2} score={1500} currentStage={9} totalStages={10} />,
    );
  ...
  it('ゲームオーバー時（途中でライフ0）の表示', () => {
    render(
      <ResultHeader lives={0} score={300} currentStage={3} totalStages={10} />,
    );
